    ...
    <div className="mb-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-5">
        <div>
          ...
          <p className="text-[13px] text-text-3 font-normal mb-0!">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          ...
          <Button color="default" variant="filled" className="bg-bidv-green! text-white! hover:bg-bidv-green-700!" icon={<RefreshCw size={16} />}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          label="LỆCH VỚI CORE"
          value={stats.diffCount.toString()}
